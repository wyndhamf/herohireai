        ...
        <AnimatePresence mode="wait">
          {isSubmitted ? (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 rounded-2xl" />
              <div className="absolute top-4 right-4 w-16 h-16 bg-emerald-200/40 rounded-full blur-xl" />
