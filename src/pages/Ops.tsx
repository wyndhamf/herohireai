    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary/10 border-b border-primary/20">
        <div className="container px-4 py-3">
          <p className="text-center text-primary font-semibold">Coming Soon - Ops</p>
        </div>
      </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">Process Optimization</h3>
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">System Implementation</h3>
                <p className="text-white/80 text-sm">
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">Quality Assurance</h3>
                <p className="text-white/80 text-sm">
