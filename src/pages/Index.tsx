        ...
        <div className="container mx-auto px-6 relative z-10 pt-20">
          ...
          >
            ...
            >
              <span>Hire</span>
              <br />
              <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent font-medium" style={{WebkitTextStroke: '1px rgba(255,255,255,0.3)'}}>Elite Talent</span>
            </motion.h1>
