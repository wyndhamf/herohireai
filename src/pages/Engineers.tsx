    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary/10 border-b border-primary/20">
        <div className="container px-4 py-3">
          <p className="text-center text-primary font-semibold">Coming Soon - Engineers</p>
        </div>
      </div>
      ...
      <main className="pt-24">
        ...
        <section className="container px-4 py-32">
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              Our engineering talent marketplace is launching soon. Get ready to scale your development team with expert engineers.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
