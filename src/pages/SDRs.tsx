      ...
      <main className="pt-24">
        ...
        <section className="container px-4 py-32">
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              Elite <span className="text-gradient font-medium">SDRs</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Our sales development talent marketplace is launching soon. Get ready to accelerate your sales pipeline with expert SDRs.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
